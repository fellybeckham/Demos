...
<div class="Servicios">
		...
		<div class="inside_Caja_Servicios">
			...
			<img src="../../img/fond_transparente.png">
				<div class ="contenedor_iconos">
					...
					<h5>Ingrese nuevo Nip</h5> <img src="../../img/asteriscolicencias.png">
					<input type="password" name="numeroNuevoNip" value="1234">
					<h5>Ingrese nuevamente su Nip</h5> <img src="../../img/asteriscolicencias.png">
					<input type="password" name="numeroNuevamenteNip" value="1234">
	...
	<a href="<?php echo base_url();?>" id="continuar" class="btn-continuar"></a>
	<div class="pie"></div>
</div>
	</body>
</html>
